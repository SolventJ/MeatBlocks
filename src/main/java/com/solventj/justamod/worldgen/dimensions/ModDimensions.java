package com.solventj.justamod.worldgen.dimensions;
...
public class ModDimensions {
    public static final ResourceKey<LevelStem> KEY = ResourceKey.create(Registries.LEVEL_STEM,
            ResourceLocation.fromNamespaceAndPath(JustAMod.MOD_ID, "penis"));
    ...
    public static final ResourceKey<DimensionType> DIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            ResourceLocation.fromNamespaceAndPath(JustAMod.MOD_ID, "penis_type"));
